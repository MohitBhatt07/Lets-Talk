...
const register = async (req, res) => {
  ...
  try {
    ...
    const newuser = await user.create({ email, password, name: fullname });
...
module.exports = {register , login,validUser,logout, googleAuth,updateInfo ,getUserById,searchUsers};